...
GLOSSARY: dict[str, str] = {
    ...
    "Bid-Ask Spread": "Mid 與吃單價的落差佔 Mid 的比例，衡量買賣價差"
                      "衍生的進場成本劣化。",
    ...
    "Mid": "買賣報價中點；主數字改採最差成交口徑後僅供參考。",
    "Natural": "直接吃對手單的價格：買付 Ask、賣收 Bid。主數字的成本口徑。",
    ...
    "佔本金%": "最佳候選的每口成本（最差成交成本×100）除以你設定的資金總額；僅在分析當下有設定資金時記錄。",
