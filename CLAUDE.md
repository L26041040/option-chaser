...
- **V4** [#52] — 刷新與分析：進度／失敗指引／新鮮度（commits `067983c`／`b3bfc3d`）：
  ...
  **兩份檢視均已處理**（commit `b3bfc3d`）。真 bug 一個：`create()` 用
...
- **V5** [#53] — 詳細頁核心：Heatmap＋摘要＋追平標示（commit `e144b75`）：
...
- **V6** [#54] — 到期日結構：橫向按鈕＋Top 10 含腿價（commit `dda9411`）：
