...
本輪目前**沒有下一張**——待辦清單上可施工的票（T1–T12、QA1-01–QA1-12、
D1）已全數完成。剩下三張不在本次施工範圍：

- **QA-v1 修正輪**（tracking [#27]，來源 `docs/QA-v1.md`，2026-08-02 拆票完成，
  QA1-01 至 QA1-12 全數完成）：
  - 下一版不施工：QA1-13 [#40] 最好／最差價位、QA1-14 [#41] 上方功能區
  - 待需求方裁示：QA1-15 [#42] 使用者角度補充建議清單（裁示前不施工）

**是否現在開 PR？** 「全部 ticket 做完才開 PR」的規則本身沒有明講
QA1-13/14/15 算不算數——QA1-13/14 明確排定下一版才做，QA1-15 明確要
等裁示，兩者性質都不是「還沒排到」而是「這輪範圍外」。這點屬於規則
字面沒寫清楚、且會改變下一步行為（現在開 PR vs. 繼續等）的情況，
按規則本身的例外條款（真正需要需求方裁示才停）留給需求方確認，不
自行認定。
